...
\begin{frame}{Greedy Constructive Algorithm}
    \begin{columns}
        ...
        \footnotesize{\input{pseudocodes/greedy}}
    \end{columns}
\end{frame}
...
\begin{frame}{Random Keys Based Constructive Algorithm}
    \begin{columns}
        \column{0.02\textwidth}
        \column{0.98\textwidth}
        \footnotesize{\input{pseudocodes/random_keys}}
    \end{columns}
\end{frame}
...
\begin{frame}{Best Improvement}
    \begin{columns}
        \column{0.02\textwidth}
        \column{0.98\textwidth}
        \footnotesize{\input{pseudocodes/best_improvement}}
    \end{columns}
\end{frame}
...
\begin{frame}{First Improvement}
    \begin{columns}
        \column{0.02\textwidth}
        \column{0.98\textwidth}
        \footnotesize{\input{pseudocodes/first_improvement}}
    \end{columns}
\end{frame}
...
\begin{frame}{Results}
    \input{tables/results1}
\end{frame}

\begin{frame}{Results}
    \input{tables/results2}
\end{frame}
...
\begin{frame}{Conclusions about local searches}
    \begin{itemize}
        ...
        \item \textbf{Random key + BI}: 11582s, 485 iterations
